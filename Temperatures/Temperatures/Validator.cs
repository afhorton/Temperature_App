...

{
    ...
    public static class Validator
    {
        ...
        {
            bool isValid = true;
            if (!Int32.TryParse(textBox.Text, out int result)) // not an int
            {
        ...
        {
            bool isValid = true;
            if (!Double.TryParse(textBox.Text, out double result)) // not a double
            {
        ...
        {
            bool isValid = true;
            if (!Decimal.TryParse(textBox.Text, out decimal result)) // not a decimal
            {
                MessageBox.Show(textBox.Tag + " has to be a number.");
                textBox.SelectAll(); // select all text in the box for replacement
                textBox.Focus();
        ...
        /// <summary>
        /// checks if text box contains an into value within range
        /// </summary>
        /// <param name="textBox">text box to check (Tag property is set)</param>
        /// <param name="minVal">minimum value for the range</param>
        /// <param name="maxVal">maximum value for the range</param>
